...
public class CreateXMLFile {
    public static void main(String[] args) {
        try {
            ...
            StreamResult result = new StreamResult(new File("src/lr10/resources/books.xml"));
            transformer.transform(source, result);

            System.out.println("XML-файл успешно создан по пути: src/lr10/resources/books.xml");
